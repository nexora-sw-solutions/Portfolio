...
import { Bot, Cpu, Camera, ArrowUpCircle, Check, Scan, Database } from "lucide-react";
import Image from "next/image";
import { ProjectItem } from "@/data/projects";

interface ApexDriveShowcaseProps {
  project: ProjectItem;
}

export default function ApexDriveShowcase({ project }: ApexDriveShowcaseProps) {
  ...
  const features = [
    { text: "ANPR Vision (EasyOCR)", color: "text-amber-400" },
    { text: "Autonomous SDR (n8n & OpenAI)", color: "text-emerald-400" },
    { text: "Real-time Vehicle Tracking", color: "text-cyan-400" },
    { text: "Interactive Recharts Data", color: "text-fuchsia-400" },
  ];
        ...
        <div className="md:col-span-7 relative w-full flex items-center justify-center py-6 sm:py-8">
          ...
          >
            ...
            <div className="text-left leading-tight pr-1">
              <div className="text-[9px] font-extrabold uppercase tracking-wide">Autonomous SDR</div>
              <div className="text-[8px] font-semibold text-slate-400 mt-0.5">n8n & OpenAI engine</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-left leading-tight pr-1">
              <div className="text-[9px] font-extrabold uppercase tracking-wide">ANPR Vision</div>
              <div className="text-[8px] font-semibold text-slate-400 mt-0.5">EasyOCR processing</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-2.5 bg-slate-950/80 border-b border-slate-800/60 select-none">
              ...
              <div className="flex items-center justify-center gap-1 px-3 py-0.5 text-[9px] font-medium text-slate-400 bg-slate-900/80 border border-slate-800/60 rounded-md w-1/2 max-w-[200px] truncate">
                ...
                <span className="truncate">crm.apexdrive.io</span>
              </div>
