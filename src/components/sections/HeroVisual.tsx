    ...
    <div className="absolute inset-0 right-0 w-full lg:w-1/2 h-full flex items-center justify-center pointer-events-none z-0 lg:z-10 opacity-20 lg:opacity-100 ml-auto pl-6 lg:pl-0">
      <div className="relative w-full max-w-2xl h-[400px] lg:h-[600px] flex items-center justify-center mt-12 lg:mt-0">
        ...
        <motion.div
          ...
          className="absolute z-10 w-[85%] max-w-[550px] -translate-x-4 lg:-translate-x-8 translate-y-4 animate-float"
        ...
        <motion.div
          ...
          className="absolute z-20 w-[45%] max-w-[280px] right-2 lg:-right-4 -bottom-4 lg:-bottom-8 animate-float-delayed"
        ...
        <motion.div
          ...
          className="absolute z-30 w-[28%] max-w-[160px] left-0 lg:-left-12 top-4 lg:top-12 animate-float"
